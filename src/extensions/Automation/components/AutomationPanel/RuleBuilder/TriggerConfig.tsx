    ...
    return (
      <div className="flex flex-col gap-3 rounded-md border border-border bg-bg-surface/50 p-3">
        <div>
          ...
          >
            <option value="">
              {translations['automation.triggerConfig.customField.selectFieldPlaceholder']}
            </option>
        ...
        {customFields.length === 0 && (
          <p className="text-xs text-muted italic">
            {translations['automation.triggerConfig.customField.noFields']}
          </p>
        )}
        ...
        {selectedField && (
          <div>
            ...
            {selectedField.field_type === 'CHECKBOX' && (
              ...
              >
                <option value="false">
                  {translations['automation.triggerConfig.customField.checkboxFalse']}
                </option>
                <option value="true">
                  {translations['automation.triggerConfig.customField.checkboxTrue']}
                </option>
              </select>
            )}
            ...
            {selectedField.field_type === 'DROPDOWN' && (
              ...
              >
                <option value="">
                  {translations['automation.triggerConfig.customField.selectOptionPlaceholder']}
                </option>
