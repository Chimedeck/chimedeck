  ...
  <div className="flex flex-col items-center justify-center gap-4 px-6 py-12 text-center">
    ...
    <div>
      <p className="text-sm font-medium text-subtle">
        {translations['automation.scheduleEmptyState.title']}
      </p>
    ...
    <div className="flex flex-col gap-2 w-full max-w-xs">
      <Button variant="primary" onClick={onCreateScheduled} className="w-full">
        {translations['automation.scheduleEmptyState.createScheduled']}
      </Button>
      <Button variant="secondary" onClick={onCreateDueDate} className="w-full">
