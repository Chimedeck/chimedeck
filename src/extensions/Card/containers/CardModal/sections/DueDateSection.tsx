...
export const DueDateSection = ({ dueDate, onChange, disabled }: Props) => (
  <section aria-label="Due date">
    <h3 className="mb-1 text-sm font-semibold text-gray-700">Due date</h3>
    <div className="flex items-center gap-2">
      <input
        type="date"
        className="rounded border border-gray-300 px-2 py-1 text-sm focus:border-blue-400 focus:outline-none disabled:opacity-50"
