          ...
          {pickerOpen && (
            <>
              <div
                ...
                aria-hidden="true"
              />
              <div className="absolute left-0 top-6 z-20 w-56 rounded-xl bg-slate-800 border border-slate-700 shadow-2xl p-2 space-y-1">
                {boardMembers.length === 0 && (
                  <p className="text-xs text-slate-500 px-2 py-1">No board members</p>
                )}
