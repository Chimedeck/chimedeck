...
Add a **"MCP Docs"** entry to the main sidebar that opens a developer-reference page documenting the Horiflow MCP server — how to connect, how to authenticate, and the full list of available tools with their input schemas and example usage.
...
| # | Section | Content |
|---|---------|---------|
| 1 | Overview | What Horiflow MCP is; two things needed to connect (URL + API token) |
