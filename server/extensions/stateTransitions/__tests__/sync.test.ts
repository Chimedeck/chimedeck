...
import { renameNode, stripDeletedNodes } from '../common/sync';
...
const graph: StateTransitionGraph = {
  ...
  notes: [{ id: 'note-1', content: 'note', positionX: 1, positionY: 2 }],
};

describe('stateTransitions sync', () => {
  it('stripDeletedNodes removes deleted list nodes and dangling edges', () => {
  ...
  it('renameNode updates node label from active list title', () => {
    const synced = renameNode(graph, [
