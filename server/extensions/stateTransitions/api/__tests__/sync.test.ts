...
import { stripDeletedNodes, updateNodeLabels } from '../../common/sync';
...
describe('stateTransitions sync integration helpers', () => {
  it('removes deleted list nodes and related edges', () => {
  ...
  it('renames node labels from active lists', () => {
    const synced = updateNodeLabels(sampleGraph, [
