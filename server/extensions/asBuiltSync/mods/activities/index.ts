 ...
 */
export async function emitAsBuiltActivity(input: AsBuiltActivityInput): Promise<void> {
  try {
...
export async function emitAsBuiltEvidenceCollected({
  ...
  return emitAsBuiltActivity({
    type: 'as_built_sync_evidence_collected',
    cardId,
    boardId,
    runId,
    actorId,
...
export async function emitAsBuiltDocsUpdated({
  ...
  return emitAsBuiltActivity({
    type: 'as_built_sync_docs_updated',
    cardId,
    boardId,
    runId,
    actorId,
