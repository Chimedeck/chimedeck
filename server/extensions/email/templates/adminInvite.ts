...
export function adminInviteEmail({
  ...
  const subject = 'You have been invited to HoriFlow';

  const text = [
    `You have been invited to HoriFlow by ${inviterName}.`,
    '',
    'Your login details:',
    `  Email:    ${newUserEmail}`,
...
<body style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;color:#1e293b">
  <h1 style="font-size:24px;font-weight:700;margin-bottom:8px">You have been invited to HoriFlow</h1>
  <p style="color:#475569;margin-bottom:16px">
    <strong>${inviterName}</strong> has created an account for you on HoriFlow.
  </p>
  ...
  <a href="${loginUrl}" style="display:inline-block;background:#4f46e5;color:#fff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600">Log in to HoriFlow</a>
