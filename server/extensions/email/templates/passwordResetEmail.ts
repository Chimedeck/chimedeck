...
export function buildPasswordResetEmail({
  ...
  const subject = 'Reset your password — HoriFlow';

  const text = `You requested a password reset for your HoriFlow account.\n\nClick the link below to set a new password:\n\n${resetUrl}\n\nThis link expires in ${expiresIn}.\n\nIf you did not request this, you can safely ignore this email.`;
...
<body style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;color:#1e293b">
  ...
  <p style="color:#475569;margin-bottom:24px">You requested a password reset for your HoriFlow account. Click the button below to set a new password. The link expires in ${expiresIn}.</p>
