...
export function buildEmailChangeConfirmation({
  ...
  const subject = 'Confirm your email change — Kanban';

  const text = `You requested to change your Kanban account email to ${newEmail}.\n\nConfirm the change by visiting the link below:\n\n${confirmUrl}\n\nThis link expires in ${expiresIn}.\n\nIf you did not request this change, you can safely ignore this email.`;
...
<body style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;color:#1e293b">
  ...
  <p style="color:#475569;margin-bottom:8px">You requested to change your Kanban account email to:</p>
