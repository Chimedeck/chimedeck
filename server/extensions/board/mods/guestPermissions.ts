...
export const guestCanWrite = (guestType: GuestType): boolean => guestType === 'MEMBER';
...
export const guestDeniedError = (guestType: GuestType): string =>
  guestType === 'VIEWER' ? 'guest-viewer-insufficient-permissions' : 'guest-role-no-org-access';
