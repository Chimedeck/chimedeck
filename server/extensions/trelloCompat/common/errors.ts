export function trelloError(message: string, status: number): Response {
  const error = status === 401 || status === 403 ? 'UNAUTHORIZED' : 'ERROR';
...
export const TRELLO_COMMENT_NOT_FOUND = () =>
  trelloError('The requested action was not found.', 404);
export const TRELLO_CHECKLIST_NOT_FOUND = () =>
  trelloError('The requested checklist was not found.', 404);
export const TRELLO_LABEL_NOT_FOUND = () => trelloError('The requested label was not found.', 404);
export const TRELLO_MEMBER_NOT_FOUND = () =>
  trelloError('The requested member was not found.', 404);
export const TRELLO_ORGANIZATION_NOT_FOUND = () =>
  trelloError('The requested organization was not found.', 404);
export const TRELLO_ACTION_NOT_FOUND = () =>
  trelloError('The requested action was not found.', 404);
